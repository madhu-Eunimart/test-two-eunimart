...
const LspProviderSchema = new mongoose.Schema({
  ...
  locations: {
    type: [LspProviderLocationSchema]
  }
}, {
  _id: false
});
...
const LspOrderItemSchema = new mongoose.Schema({
  ...
  quantity: {
    type: LspItemQuantityAllocatedSchema
  },
  price: {
    type: Object
  }
...
const LspCustomerSchema = new mongoose.Schema({
  person: {
    type: LspPersonSchema
  },
  contact: {
    type: LspContactSchema
  }
}, {
  _id: false
});
...
const LspLocationSchema = new mongoose.Schema({
  ...
  country: {
    type: LspCountrySchema
  },
  circle: {
    type: LspCircleSchema
  },
  polygon: {
    type: String
  },
...
const LspFulfillmentSchema = new mongoose.Schema({
  ...
  vehicle: {
    type: LspVehicleSchema
  },
  start: {
    type: LspFulfillmentStartorEndSchema
  },
  end: {
    type: LspFulfillmentStartorEndSchema
  },
...
const LspQuotationSchema = new mongoose.Schema({
  ...
  breakup: {
    type: [LspQuotationBreakupSchema]
  },
  ttl: {
    type: String
  }
...
const LspPaymentSchema = new mongoose.Schema({
  ...
  "@ondc/org/settlement_details": {
    type: [LspCodSettlementDetailsSchema]
  },
  uri: {
    type: String
  },
...
const LspOndcOrgCancellationSchema = new mongoose.Schema({
  ...
  reasons: {
    type: LspReasonSchema
  },
  selected_reason: {
    type: LspSelectedReasonSchema
  },
...
const LspOndcLinkedOrderSchema = new mongoose.Schema({
  items: {
    type: [LspLinkedOrderItemSchema]
  },
  provider: {
    type: LspLinkedOrderProviderSchema
  },
  order: {
    type: LspOndcLinkedOrderSchemaOrderSchema
  }
}, {
  _id: false
});
...
const LspOrderSchema = new mongoose.Schema({
  ...
  //[Draft, Created, Accepted, In-progress, Completed, Cancelled]
  provider: {
    type: LspProviderSchema
  },
  items: {
    type: [LspOrderItemSchema]
  },
  add_ons: {
    type: [LspAddOnsSchema]
  },
  offers: {
    type: [LspOfferSchema]
  },
  documents: {
    type: [LspDocumentsSchema]
  },
  billing: {
    type: LspBillingSchema
  },
  fulfillments: {
    type: [LspFulfillmentSchema]
  },
  quote: {
    type: LspQuotationSchema
  },
  payment: {
    type: LspPaymentSchema
  },
  "@ondc/org/created_by": {
    type: String
  },
  "@ondc/org/cancellation": {
    type: LspOndcOrgCancellationSchema
  },
  "@ondc/org/linked_order": {
    type: LspOndcLinkedOrderSchema
  },
  cancellation_terms: {
    type: Object
  },
