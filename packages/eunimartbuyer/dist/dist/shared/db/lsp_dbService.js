...
const UpsertLspBapUserCartOrder = async (query, data) => {
  return await LspBapUserCart.findOneAndUpdate(query, data, {
    upsert: true
  });
};
...
export { CreateLspOrder, GetLspOrder, UpdateLspOrder, DeleteLspOrder, ListLspOrder, UpsertLspOrder, UpsertLspBapUserCartOrder, GetLspBapUserCartOrder, ListLspBapUserCartOrder };