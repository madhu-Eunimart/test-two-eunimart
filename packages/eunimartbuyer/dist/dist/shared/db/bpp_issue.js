...
//     {
//         issue_update_info: {type:DescriptorSchema},
...
const IssueActionSchema = new mongoose.Schema({
  complainant_actions: {
    type: [ComplainantActionStatusSchema]
  },
  respondent_actions: {
    type: [RespondentActionStatusSchema]
  }
  // id: {type: String, default: () => uuidv4()},
  // status: {type: String, default: "open"},
  // modified_by : {type:Object},
...
const IssueActionsSchema = new mongoose.Schema({
  complainant_actions: {
    type: [ComplainantActionSchema]
  },
  respondent_actions: {
    type: [RespondentActionSchema]
  }
}, {
  _id: false,
  timestamps: false
...
const IssueSchema = new mongoose.Schema({
  ...
  additional_info_required: {
    type: [AdditionalInfoRequiredSchema]
  }
}, {
  _id: false,
  timestamps: false
