...
const FulfillmentSchema = new mongoose.Schema({
  ...
  start: {
    type: FulfillmentStartSchema
  },
  end: {
    type: FulfillmentEndSchema
  },
  purpose: {
    type: String
  },
...
const ItemsSchema = new mongoose.Schema({
  ...
  quantity: {
    type: ItemQuantityAllocatedSchema,
    required: true
  },
  descriptor: {
    type: DescriptorSchema
...
const OrderSchema = new mongoose.Schema({
  ...
  paymentStatus: {
    type: String,
    enum: PROTOCOL_PAYMENT,
    default: PROTOCOL_PAYMENT["NOT-PAID"]
  },
  bppDescriptor: {
    type: Object
  },
  ...
  logistics_network_order_id: {
    type: String,
    default: ""
  },
  logistics_seller_np_name: {
    type: String,
    default: ""
  },
  logistics_network_transaction_id: {
    type: String,
    default: ""
  },
  cancelled_at: {
