...
const onConfirmPayment = {
  "id": "/onConfirmPayment",
  "type": "object",
  "required": ["type", "collected_by", "status", "@ondc/org/buyer_app_finder_fee_type", "@ondc/org/buyer_app_finder_fee_amount", "@ondc/org/settlement_details"],
  "properties": {
    "uri": {
      "type": "string",
      "minLength": 1
    ...
    "type": {
      "type": "string",
      "enums": Object.values(PAYMENT_TYPES)
    },
    "collected_by": {
      "type": "string",
      "enum": Object.values(PAYMENT_COLLECTED_BY)
    },
    "@ondc/org/buyer_app_finder_fee_type": {
      "type": "string",
      "enum": Object.values(FINDER_FEE_TYPE)
    },
    "status": {
      "type": "string",
      "minLength": 1
  ...
  "properties": {
    "order": {
      ...
      "properties": {
        ...
        "state": {
          "type": "string",
          "enum": Object.values(RETAIL_ORDER_STATE)
        },
        "provider": {
          "$ref": "/onConfirmProvider"
        },
        "items": {
          "$ref": "/onConfirmItems"
        },
        "billing": {
          "$ref": "/onConfirmBilling"
        },
        "fulfillments": {
          "$ref": "/onConfirmFulfillments"
        },
        "quote": {
          "$ref": "/onConfirmQuote"
        },
        "payment": {
          "$ref": "/onConfirmPayment"
        },
        "documents": {
          "$ref": "/onConfirmDocument"
        },
        "created_at": {
          "type": "string",
          "minLength": 1
...
const onConfirm = {
  ...
  "properties": {
    "context": {
      "$ref": "/onConfirmContext"
    },
    "message": {
      "$ref": "/onConfirmMessage"
    }
  }
};
