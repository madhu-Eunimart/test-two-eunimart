...
const order_state = {
  ...
  "properties": {
    "type": {
      "type": "string",
      enum: Object.keys(RETAIL_ORDER_STATE)
    }
  }
};
const finder_fee_type = {
  ...
  "properties": {
    "type": {
      "type": "string",
      enum: Object.keys(FINDER_FEE_TYPE)
    }
  }
};
const status = {
  ...
  "properties": {
    "type": {
      "type": "string",
      enum: Object.keys(PROTOCOL_PAYMENT)
    }
  }
};
...
const collected_by = {
  ...
  "properties": {
    "type": {
      "type": "string",
      enum: Object.keys(PAYMENT_COLLECTED_BY)
    }
  }
};
const confirmPayment = {
  "id": "/confirmPayment",
  "type": "object",
  "required": ["uri", "tl_method", "params", "type", "collected_by", "@ondc/org/buyer_app_finder_fee_type", "@ondc/org/buyer_app_finder_fee_amount",
