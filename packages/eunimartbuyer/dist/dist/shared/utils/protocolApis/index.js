...
const protocolConfirm = async (uri, data) => {
  ...
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.CONFIRM, "POST", {
    ...data
  }, {
...
const onOrderConfirm = async messageId => {
  const apiCall = new HttpRequest(Configuration?.PROTOCOL_BASE_URL, PROTOCOL_API_URLS.ON_CONFIRM + "?messageId=" + messageId, "get");
  const result = await apiCall.send();
  return result.data;
};
...
const protocolCancel = async (url, data) => {
  const authHeader = await createAuthorizationHeader(data);
  const apiCall = new HttpRequest(url, PROTOCOL_API_URLS.CANCEL, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const protocolReturn = async (url, data) => {
  const authHeader = await createAuthorizationHeader(data);
  const apiCall = new HttpRequest(url, PROTOCOL_API_URLS.RETURN, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const onOrderCancel = async messageId => {
  const apiCall = new HttpRequest(Configuration?.PROTOCOL_BASE_URL, PROTOCOL_API_URLS.ON_CANCEL + "?messageId=" + messageId, "get");
  const result = await apiCall.send();
  return result.data;
};
...
const protocolInit = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.INIT, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const onOrderInit = async messageId => {
  const apiCall = new HttpRequest(Configuration?.PROTOCOL_BASE_URL, PROTOCOL_API_URLS.ON_INIT + "?messageId=" + messageId, "get");
  const result = await apiCall.send();
  return result.data;
};
...
const protocolSearch = async data => {
  ...
  const protocol_base_url = lookupgateway?.[0]?.subscriber_url ? lookupgateway?.[0]?.subscriber_url : Configuration?.PROTOCOL_BASE_URL;
  const apiCall = new HttpRequest(protocol_base_url, PROTOCOL_API_URLS.SEARCH, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const onSearch = async query => {
  const queryString = Object.keys(query).map(key => {
    if (typeof key !== "undefined" && typeof query[key] !== "undefined") return encodeURIComponent(key) + '=' + encodeURIComponent(query[key]);
  }).join('&');
  const apiCall = await fetch(Configuration?.PROTOCOL_BASE_URL + "/" + PROTOCOL_API_URLS.ON_SEARCH + "?" + queryString);
...
const protocolTrack = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.TRACK, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const onOrderTrack = async messageId => {
  const apiCall = new HttpRequest(Configuration?.PROTOCOL_BASE_URL, PROTOCOL_API_URLS.ON_TRACK + "?messageId=" + messageId, "get");
  const result = await apiCall.send();
  return result.data;
};
...
const protocolSupport = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.SUPPORT, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const protocolRating = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.RATING, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const onOrderSupport = async messageId => {
  const apiCall = new HttpRequest(Configuration?.PROTOCOL_BASE_URL, PROTOCOL_API_URLS.ON_SUPPORT + "?messageId=" + messageId, "get");
  const result = await apiCall.send();
  return result.data;
};
...
const bppProtocolOnRating = async (uri, data) => {
  ...
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.ON_RATING, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const protocolOrderStatus = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.STATUS, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const onOrderStatus = async messageId => {
  const apiCall = new HttpRequest(Configuration?.PROTOCOL_BASE_URL, PROTOCOL_API_URLS.ON_STATUS + "?messageId=" + messageId, "get");
  const result = await apiCall.send();
  return result.data;
};
...
const protocolUpdate = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.UPDATE, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const onUpdateStatus = async messageId => {
  const apiCall = new HttpRequest(Configuration?.PROTOCOL_BASE_URL, PROTOCOL_API_URLS.ON_UPDATE + "?messageId=" + messageId, "get");
  const result = await apiCall.send();
  return result.data;
};
...
const protocolSelect = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.SELECT, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const onOrderSelect = async messageId => {
  const apiCall = new HttpRequest(Configuration?.PROTOCOL_BASE_URL, PROTOCOL_API_URLS.ON_SELECT + "?messageId=" + messageId, "get");
  const result = await apiCall.send();
  return result.data;
};
...
const onOrderIssue = async messageId => {
  const apiCall = new HttpRequest(Configuration?.PROTOCOL_BASE_URL, PROTOCOL_API_URLS.ON_S + "?messageId=" + messageId, "get");
  const result = await apiCall.send();
  return result.data;
};
...
const onOrderRating = async messageId => {
  const apiCall = new HttpRequest(Configuration?.PROTOCOL_BASE_URL, PROTOCOL_API_URLS.ON_RATE + "?messageId=" + messageId, "get");
  const result = await apiCall.send();
  return result.data;
};
...
const bppProtocolOnSearch = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data, Configuration?.BPP_ID, Configuration?.BPP_UNIQUE_KEY_ID, Configuration?.BPP_PRIVATE_KEY);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.ON_SEARCH, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const protocolGetRatingCategories = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.GET_RATING_CATEGORIES, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const protocolGetFeedbackCategories = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.GET_FEEDBACK_CATEGORIES, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const protocolGetFeedbackForm = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.GET_FEEDBACK_FORM, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const protocolIssue = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.ISSUE, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const bppProtocolRatingCategories = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data, Configuration?.BPP_ID, Configuration?.BPP_UNIQUE_KEY_ID, Configuration?.BPP_PRIVATE_KEY);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.RATING_CATEGORIES, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const bppProtocolFeedbackCategories = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data, Configuration?.BPP_ID, Configuration?.BPP_UNIQUE_KEY_ID, Configuration?.BPP_PRIVATE_KEY);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.FEEDBACK_CATEGORIES, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const bppProtocolFeedbackForm = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data, Configuration?.BPP_ID, Configuration?.BPP_UNIQUE_KEY_ID, Configuration?.BPP_PRIVATE_KEY);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.FEEDBACK_FORM, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const bppProtocolOnSelect = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data, Configuration?.BPP_ID, Configuration?.BPP_UNIQUE_KEY_ID, Configuration?.BPP_PRIVATE_KEY);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.ON_SELECT, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const bppProtocolOnInit = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data, Configuration?.BPP_ID, Configuration?.BPP_UNIQUE_KEY_ID, Configuration?.BPP_PRIVATE_KEY);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.ON_INIT, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const bppProtocolOnCancel = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data, Configuration?.BPP_ID, Configuration?.BPP_UNIQUE_KEY_ID, Configuration?.BPP_PRIVATE_KEY);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.ON_CANCEL, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const bppProtocolOnReturn = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data, Configuration?.BPP_ID, Configuration?.BPP_UNIQUE_KEY_ID, Configuration?.BPP_PRIVATE_KEY);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.ON_RETURN, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const bppProtocolOnSupport = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data, Configuration?.BPP_ID, Configuration?.BPP_UNIQUE_KEY_ID, Configuration?.BPP_PRIVATE_KEY);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.ON_SUPPORT, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const bppProtocolOnTrack = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data, Configuration?.BPP_ID, Configuration?.BPP_UNIQUE_KEY_ID, Configuration?.BPP_PRIVATE_KEY);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.ON_TRACK, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const bppProtocolOnUpdate = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data, Configuration?.BPP_ID, Configuration?.BPP_UNIQUE_KEY_ID, Configuration?.BPP_PRIVATE_KEY);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.ON_UPDATE, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const bppProtocolOnConfirm = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data, Configuration?.BPP_ID, Configuration?.BPP_UNIQUE_KEY_ID, Configuration?.BPP_PRIVATE_KEY);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.ON_CONFIRM, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const bppProtocolOnStatus = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data, Configuration?.BPP_ID, Configuration?.BPP_UNIQUE_KEY_ID, Configuration?.BPP_PRIVATE_KEY);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.ON_STATUS, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const bppProtocolOnIssueDefault = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data, Configuration?.BPP_ID, Configuration?.BPP_UNIQUE_KEY_ID, Configuration?.BPP_PRIVATE_KEY);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.ON_ISSUE, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const bapProtocolOnIssueStatus = async (uri, data) => {
  var authHeader = await createAuthorizationHeader(data, Configuration?.BAP_ID, Configuration?.BAP_UNIQUE_KEY_ID, Configuration?.BAP_PRIVATE_KEY);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.ON_ISSUE_STATUS, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const bppProtocolOnIssueStatus = async (uri, data) => {
  var authHeader = await createAuthorizationHeader(data, Configuration?.BPP_ID, Configuration?.BPP_UNIQUE_KEY_ID, Configuration?.BPP_PRIVATE_KEY);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.ON_ISSUE_STATUS, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
...
const bapProtocolOnIssueDefault = async (uri, data) => {
  const authHeader = await createAuthorizationHeader(data, Configuration?.BAP_ID, Configuration?.BAP_UNIQUE_KEY_ID, Configuration?.BAP_PRIVATE_KEY);
  const apiCall = new HttpRequest(uri, PROTOCOL_API_URLS.ON_ISSUE, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
...
const BAPApiCall = async (uri, url_type, data) => {
  const authHeader = await createAuthorizationHeader(data);
  const apiCall = new HttpRequest(uri, url_type, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
const CallWebhook = async (url_type, data) => {
  ...
  const apiCall = new HttpRequest(url, url_type, "POST", {
    ...data
  }, {
    "Accept": "application/json"
  });
...
const commonProtocolAPIForLsp = async (baseUrl, url, data, subscriberId, uniqueKeyId, privateKey) => {
  ...
  const apiCall = new HttpRequest(baseUrl, url, "POST", {
    ...data
  }, {
    "Authorization": authHeader,
    "Accept": "application/json"
...
export { commonProtocolAPIForLsp, commonProtocolAPIForIGM, commonProtocolAPIForRSP, onOrderCancel, onOrderReturn, onOrderConfirm, onOrderInit, onSearch, onOrderStatus, onOrderSupport, onOrderTrack, onOrderSelect, onOrderIssue, protocolCancel, protocolReturn, protocolConfirm, protocolInit, protocolSearch, protocolOrderStatus, protocolSupport, protocolTrack, protocolSelect, protocolUpdate, onUpdateStatus, bppProtocolOnSearch, bppProtocolOnSelect, bppProtocolOnInit, bppProtocolOnCancel, bppProtocolOnReturn, bppProtocolOnSupport, bppProtocolOnTrack, bppProtocolOnUpdate, bppProtocolOnConfirm, bppProtocolOnStatus, BAPApiCall, CallWebhook, protocolRating, bppProtocolOnRating, onOrderRating, bppProtocolRatingCategories, protocolGetRatingCategories, bppProtocolFeedbackCategories, protocolGetFeedbackCategories, bppProtocolFeedbackForm, protocolGetFeedbackForm, protocolIssue, bppProtocolOnIssue, bapProtocolOnIssue, bapProtocolOnIssueStatus, bppProtocolOnIssueStatus, bppProtocolOnIssueDefault, bapProtocolOnIssueDefault, commonProtocolAPIForIGMBPP, commonProtocolAPIForIGMBAP, SubscribeApiCall };