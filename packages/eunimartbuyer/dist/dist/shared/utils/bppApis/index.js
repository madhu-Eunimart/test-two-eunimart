...
const bppConfirm = async (bppUri, order) => {
  ...
  const apiCall = new HttpRequest(bppUri, BPP_API_URLS.CONFIRM, "POST", order, {
...
const bppCancel = async (bppUri, order) => {
  const authHeader = await createAuthorizationHeader(order);
  const apiCall = new HttpRequest(bppUri, BPP_API_URLS.CANCEL, "POST", order, {
    "Authorization": authHeader,
    "Accept": "application/json"
  });
  const result = await apiCall.send();
...
const bppInit = async (bppUri, order) => {
  const authHeader = await createAuthorizationHeader(order);
  const apiCall = new HttpRequest(bppUri, BPP_API_URLS.INIT, "POST", order, {
    "Authorization": authHeader,
    "Accept": "application/json"
  });
  const result = await apiCall.send();
...
const bppSearch = async (bppUri, message) => {
  ...
  const apiCall = new HttpRequest(bppUri, BPP_API_URLS.SEARCH, "POST", message, {
    "Authorization": authHeader,
    "Accept": "application/json"
  });
  const result = await apiCall.send();
...
const bppTrack = async (bppUri, trackRequest) => {
  ...
  const apiCall = new HttpRequest(bppUri, BPP_API_URLS.TRACK, "POST", trackRequest, {
    "Authorization": authHeader,
    "Accept": "application/json"
  });
  const result = await apiCall.send();
...
const bppSupport = async (bppUri, supportRequest) => {
  ...
  const apiCall = new HttpRequest(bppUri, BPP_API_URLS.SUPPORT, "POST", supportRequest, {
    "Authorization": authHeader,
    "Accept": "application/json"
  });
  const result = await apiCall.send();
...
const bppOrderStatus = async (bppUri, order) => {
  const authHeader = await createAuthorizationHeader(order);
  const apiCall = new HttpRequest(bppUri, BPP_API_URLS.STATUS, "POST", order, {
    "Authorization": authHeader,
    "Accept": "application/json"
  });
  const result = await apiCall.send();
...
const bppSelect = async (bppUri, request) => {
  ...
  const apiCall = new HttpRequest(bppUri, BPP_API_URLS.SELECT, "POST", request, {
    "Authorization": authHeader,
    "Accept": "application/json"
  });
  const result = await apiCall.send();
...
const bppIssue = async (bppUri, issue) => {
  ...
  const apiCall = new HttpRequest(bppUri, BPP_API_URLS.ISSUE, "POST", issue, {
    "Authorization": authHeader,
    "Accept": "application/json"
  });
  const result = await apiCall.send();
...
export { bppCancel, bppConfirm, bppInit, bppSearch, bppOrderStatus, bppSupport, bppTrack, bppSelect, bppIssue };