...
import { HEADERS } from "../../../../shared/utils/buyer_enums.js";
...
const passportJwtStrategy = new JwtStrategy(opts, async (req, jwtPayload, done) => {
  try {
    ...
    let httpRequest = new HttpRequest(process.env.MODULE_END_POINT_AUTH, `/api/users/${jwtPayload.userId}/authUser`, "GET", {}, headers);
