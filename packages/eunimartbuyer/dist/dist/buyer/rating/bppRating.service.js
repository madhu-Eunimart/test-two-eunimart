  ...
  */
  async ONDCRating(uri, ratingRequest) {
    try {
      ...
      let response = await this.ONDCRatingEvent({
        uri,
        ratingRequest
      });
  ...
  */
  async ONDCRatingCategories(uri, ratingRequest) {
    try {
      ...
      let response = await this.ONDCRatingCategoriesEvent({
        uri,
        ratingRequest
      });
      // const response = await protocolRating(uri, ratingRequest);
  ...
  */
  async ONDCFeedbackCategories(uri, ratingRequest) {
    try {
      ...
      let response = await this.ONDCFeedbackCategoriesEvent({
        uri,
        ratingRequest
      });
      // const response = await protocolRating(uri, ratingRequest);
  ...
  */
  async ONDCFeedbackForm(uri, ratingRequest) {
    try {
      ...
      let response = await this.ONDCFeedbackFormEvent({
        uri,
        ratingRequest
      });
      // const response = await protocolRating(uri, ratingRequest);
  ...
  async ONDCRatingCategoriesEvent({
    uri,
    ratingRequest
  }) {
    try {
  ...
  async ONDCFeedbackCategoriesEvent({
    uri,
    ratingRequest
  }) {
    try {
