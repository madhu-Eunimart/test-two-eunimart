...
// select order v1
rootRouter.post('/select', selectOrderController.ONDCSelectOrder);

// select order v1
rootRouter.post('/bap/full_details/select', selectOrderController.selectOrder);

// init order v1
rootRouter.post('/init', initOrderController.ONDCInitOrder);
...
// confirm order v1
rootRouter.post('/confirm', confirmOrderController.ONDCConfirmOrder);

// confirm order v1
rootRouter.post('/bap/full_details/confirm', confirmOrderController.confirmOrder);

// cancel order v1
rootRouter.post('/cancel', cancelOrderController.ONDCCancelOrder);

// cancel order v1
rootRouter.post('/bap/full_details/cancel', cancelOrderController.cancelOrder);

// update order v1
rootRouter.post('/update', updateOrderController.ONDCUpdateOrder);

// update order v1
rootRouter.post('/bap/full_detatils/update', updateOrderController.updateOrder);

// status order v1
rootRouter.post('/status', orderStatusController.ONDCStatusOrder);

// update order v1
rootRouter.post('/bap/full_details/status', orderStatusController.statusOrder);
